...
<table id = "landscapelinks">
    <tr>
        <td class = "editlinks">
            <a  id ="scrolleditorlink2" href = "pageeditor.php">
...
<table id = "portraitlinks">
    <tr>
        <td class = "editlinks">
            <a id ="scrolleditorlink" href = "pageeditor.php">
                <img src = "icons/edit.svg"/>
            </a>
        </td>
        <td class = "editlinks">
        ...
        <td id = "hidebutton" class= "button">
            <img id = "hideicon" src = "icons/showmenu.svg"/>
        </td>
...
function loadscroll(scrollname){
    filename = scrollname;
    if(filename.substring(0,8) == "pages/" || filename == "README.md"){
        localfile = true;
    }
    else{
        localfile = false;
    }
    document.getElementById("scrolleditorlink").href = "pageeditor.php?page=" + filename;
    document.getElementById("scrolleditorlink2").href = "pageeditor.php?page=" + filename;
...
function convertscrollinks(){
    ...
    for(var index = 0;index < links.length;index++){
        if(links[index].href.includes("pages/") && !links[index].href.includes(".php")){
            //console.log(links[index].href);
            var newspan = document.createElement("SPAN");
            newspan.innerHTML = links[index].innerHTML;
            var dataspan = document.createElement("SPAN");
            dataspan.className = "data";
            dataspan.innerHTML  = "pages/" + links[index].href.split("pages/")[1];
...
httpc9.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
        ...
        for(var index = 0;index < scrolls.length;index++) {
            var newscrollbutton = document.createElement("P");
            newscrollbutton.className = "boxlink";
            newscrollbutton.innerHTML = "pages/" + scrolls[index];
            document.getElementById("scrollsbox").appendChild(newscrollbutton);
            newscrollbutton.onclick = function(){
                currentFile = this.innerHTML;
                loadscroll(currentFile);
...
httpc9.open("GET", "dir.php?filename=pages", true);
httpc9.send();
